// Code generated by "gocd-response-links-generator -type=EncryptLinks"; DO NOT EDIT.
...
func (l EncryptLinks) MarshalJSON() ([]byte, error) {
	type h struct {
		H string `json:"href"`
	}
	ls := struct {
...
func (l *EncryptLinks) UnmarshalJSON(j []byte) error {
