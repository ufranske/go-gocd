// Code generated by "gocd-response-links-generator -type=AgentsLinks,AgentLinks"; DO NOT EDIT.
...
func (l *AgentsLinks) UnmarshalJSON(j []byte) error {
...
func (l *AgentLinks) UnmarshalJSON(j []byte) error {
	var d map[string]map[string]string
	e := json.Unmarshal(j, &d)
	if e != nil {
		return e
